"""
stock_weekly_top_stocks — Weekly refresh of market_top_stocks from index constituents.
...
@dag(
    dag_id="stock_weekly_top_stocks",
...
def stock_weekly_top_stocks():
    ...
    rebuild_top_stocks = stock_bash_task(
        "rebuild_top_stocks",

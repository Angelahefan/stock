"""
stock_fundamentals_weekly — Weekly bulk fundamentals crawl for ALL exchanges.
...
@dag(
    dag_id="stock_fundamentals_weekly",
...
def stock_fundamentals_weekly():
    crawl = stock_bash_task(
